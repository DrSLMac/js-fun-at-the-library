...
var title = "'Under the Whispering Door'"
console.log(title);
...
var sequel = `The sequel to ${title} is called 'The House on the Cerulean Sea'`
console.log(sequel);
...
if (isFavorite === true) {
  ...
  console.log(`I recently read a book entitled ${title}.`)
}
...
var books = ["'Under the Whispering Door'", "'The Atomic Habit'", "'The Four Winds'", "'Greenlights'", "'My Oxford Year'"]
...
var belowTwoHundred = [40, 53, 127, 56,95,12,84,37,65,110,185,61];
